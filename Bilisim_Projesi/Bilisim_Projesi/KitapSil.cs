...
namespace Bilisim_Projesi
{
    public partial class KitapSil : Form
    {
        ...
        {
            baglanti.Open();
            OleDbCommand komut = new OleDbCommand("delete from Kitap where kitapno='" + textBox5.Text.ToString() + "'", baglanti);
        ...
        {
            MessageBox.Show("Silmek istedğiniz Kitap Numarasını Giriniz");
        }
    }
}
